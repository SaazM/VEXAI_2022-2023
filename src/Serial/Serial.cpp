...
Code written a LONG TIME ago by 7405X 2019-2020. We don't really understand it. Just know that you should be
doing
lib7405x::Serial::Instance()->send(lib7405x::Serial::STDOUT, "[insert message here]")
to send a message to the NANO

and that to receive a message from the Nano, you do

lib7405x::Serial::Instance()->onReceive("whole_data", func);

void func(nlohmann::json msg)
{
